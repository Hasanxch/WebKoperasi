...
<div id="myDiv">
    <!--HEADER-->
    <?php require 'assets/header_beranda.php'?>
    <!--/ HEADER-->
    <!---->
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="wrap-item text-center">
                        <div class="item-img">
                            <img src="<?php echo base_url('assets/'); ?>img/ser01.png">
                        </div>
                ...
                <div class="row">
                    <div class="testimonial-item">
                        <ul class="bxslider">
                            <li>
                                <blockquote>
                                    <img src="<?php echo base_url('assets/'); ?>img/thumb.png" class="img-responsive">
